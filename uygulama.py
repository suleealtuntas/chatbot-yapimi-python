...
def veritabanini_yukle():
    with open('C:\\Users\\sulee\\OneDrive\\Masaüstü\\chatbot\\veritabani.json', 'r') as dosya:
        return json.load(dosya)
    
def veritabanina_yaz(veriler):
    with open('C:\\Users\\sulee\\OneDrive\\Masaüstü\\chatbot\\veritabani.json', 'w') as dosya:
